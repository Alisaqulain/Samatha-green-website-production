...
files["contact.html"] = page({
  ...
  description: "Call +91 80500 18267 or email samathagreenenergy@gmail.com for solar consultation, site survey, and AMC support.",
  root: "",
  pageName: "contact",
  file: "contact.html",
  cta: true,
  ...
  <div class="mx-auto grid max-w-[1280px] gap-10 lg:grid-cols-2">
    ...
    <div>
      ...
      <form id="enquiry-form" class="mt-7 rounded-[28px] bg-white px-6 py-7">
        ...
        <p id="enquiry-success" class="hidden mt-3 text-sm font-bold text-brand-green">Thank you. Your enquiry has been sent. Our team will get back to you soon.</p>
        <p id="enquiry-error" class="hidden mt-3 text-sm font-bold text-red-600">We could not send your enquiry. Please email us directly or call +91 80500 18267.</p>
      </form>
    </div>
  </div>
</section>
<section class="bg-white px-4 py-16">
  ...
  <div class="mx-auto mt-12 grid max-w-[980px] grid-cols-2 gap-8 sm:grid-cols-4">
    ...
    <a href="mailto:samathagreenenergy@gmail.com" class="quick-action flex flex-col items-center gap-3.5 text-center"><span class="quick-icon flex h-[72px] w-[72px] items-center justify-center rounded-full bg-[#eef3f8] text-[#1d4f91] sm:h-[80px] sm:w-[80px]">${icon("email", 28)}</span><span class="quick-label text-[14px] font-extrabold text-[#0A2540]">Email Support</span></a>
  </div>
</section>
