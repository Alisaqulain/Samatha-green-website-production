...
(async () => {
  ...
  await visit("/contact.html", async () => {
    ...
    await page.evaluate(() => {
      ...
      document.querySelector("#enquiry-form button[type='submit']").click();
    });
    await page.waitForFunction(() => !document.querySelector("#enquiry-success").classList.contains("hidden"), { timeout: 5000 });
